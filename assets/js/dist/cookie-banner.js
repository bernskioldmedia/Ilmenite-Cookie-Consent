...
var Ilmenite_Cookie_Consent = (function($, ilcc) {
  ...
  var module = {
    ...
    setCookie: function setCookie() {
      ...
      if (!module.settings.noCookieMode) {
        ...
        var date = new Date();
        date.setTime(
          date.getTime() + module.settings.consentDuration * 24 * 60 * 60 * 1000
        );

        // Set the actual cookie
        document.cookie =
          module.settings.cookieName +
          "=" +
          module.settings.cookieActiveValue +
          "; expires=" +
          date.toGMTString() +
          "; path=/";
      }
    ...
    createBanner: function createBanner() {
      ...
      var consentBlockHeight = $(
        ".js--ilcc-cookie-consent-notice"
      ).innerHeight();
  ...
  $(window).load(function() {
    if (
      module.getCookieValue(module.settings.cookieName) !=
      module.settings.cookieActiveValue
    ) {
      module.createBanner();
    }
